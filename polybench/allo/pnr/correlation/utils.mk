...
COMMON_REPO ?= $(shell bash -c 'export MK_PATH=$(MK_PATH); echo $${MK_PATH%/work/shared/users/phd/nz264/pldi/polybench/allo/correlation/*}')
...
ifeq ($(TARGET),$(filter $(TARGET),sw_emu hw_emu))
	...
	$(ECHO) '$(EXECUTABLE) kernel_correlation.xclbin' >> run_app.sh
