...
COMMON_REPO ?= $(shell bash -c 'export MK_PATH=$(MK_PATH); echo $${MK_PATH%/work/shared/users/phd/nz264/pldi/polybench/allo/atax/*}')
...
ifeq ($(TARGET),$(filter $(TARGET),sw_emu hw_emu))
	...
	$(ECHO) '$(EXECUTABLE) kernel_atax.xclbin' >> run_app.sh
