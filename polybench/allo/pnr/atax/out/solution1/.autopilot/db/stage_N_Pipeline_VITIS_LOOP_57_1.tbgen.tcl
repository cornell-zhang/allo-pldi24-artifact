set moduleName stage_N_Pipeline_VITIS_LOOP_57_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {stage_N_Pipeline_VITIS_LOOP_57_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ out_Ax_fifo1 int 32 regular {fifo 0 volatile }  }
	{ v11 float 32 regular {array 390 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "out_Ax_fifo1", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "v11", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ out_Ax_fifo1_dout sc_in sc_lv 32 signal 0 } 
	{ out_Ax_fifo1_num_data_valid sc_in sc_lv 10 signal 0 } 
	{ out_Ax_fifo1_fifo_cap sc_in sc_lv 10 signal 0 } 
	{ out_Ax_fifo1_empty_n sc_in sc_logic 1 signal 0 } 
	{ out_Ax_fifo1_read sc_out sc_logic 1 signal 0 } 
	{ v11_address0 sc_out sc_lv 9 signal 1 } 
	{ v11_ce0 sc_out sc_logic 1 signal 1 } 
	{ v11_we0 sc_out sc_logic 1 signal 1 } 
	{ v11_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v11_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v11", "role": "we0" }} , 
 	{ "name": "v11_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v11", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	v11 { ap_memory {  { v11_address0 mem_address 1 9 }  { v11_ce0 mem_ce 1 1 }  { v11_we0 mem_we 1 1 }  { v11_d0 mem_din 1 32 } } }
}
