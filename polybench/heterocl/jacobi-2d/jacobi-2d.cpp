...
void compute_A(
  ...
  #pragma HLS array_partition variable=A_reuse_0 cyclic factor=10 dim=1
  #pragma HLS array_partition variable=A_reuse_0 cyclic factor=10 dim=2

  float A_reuse_1[3][3];	// L7
  #pragma HLS array_partition variable=A_reuse_1 cyclic factor=10 dim=1
  #pragma HLS array_partition variable=A_reuse_1 cyclic factor=10 dim=2
...
void compute_B(
  ...
  #pragma HLS array_partition variable=v23 cyclic factor=10 dim=2

  #pragma HLS array_partition variable=v24 cyclic factor=10 dim=2

  float B_reuse_0[3][250];	// L45
  #pragma HLS array_partition variable=B_reuse_0 cyclic factor=10 dim=1
  #pragma HLS array_partition variable=B_reuse_0 cyclic factor=10 dim=2

  float B_reuse_1[3][3];	// L46
  #pragma HLS array_partition variable=B_reuse_1 cyclic factor=10 dim=1
  #pragma HLS array_partition variable=B_reuse_1 cyclic factor=10 dim=2
